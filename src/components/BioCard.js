  ...
  return (  
    <div className="card p-4 home-card shadow">
      <div className="card-body">
        ...
        <p>
          My career in tech started in Portland Oregon with supporting Insurance CRM, training, and implementing clients.  I gained expertise in the application and a love for the business of software.  Then I took a role on the Product team and continued contributing to the development of new features.  
        </p>
        <p>
          As a Product Owner, I exercised skills in agile project management, feature design, functional testing, and release management.   Later I continued to level up in UI/UX, product packaging, strategy, and release management.  Of all the elements of the job, my favorite was the time spent working shoulder-to-shoulder with developers. This led me to consider a career change to software engineering.
        </p> 
        <p>
